...
export const ROSTER: PlayerSpec[] = [
  ...
  p(1, 'Nurul Aisyah Rahim', 'Communications', 'desktop', 'Head of Communications. 12 years in public affairs, decisive, writes the holding statement herself.'),
  p(2, 'Daniel Tan Wei Ming', 'Communications', 'phone', 'Social media executive, 2 years in. Fast on platforms, watches trending threads.'),
  p(3, 'Farah Iskandar', 'Communications', 'phone', 'Community content lead. Writes in Malay and English, strong instinct for tone.'),
  p(4, 'Priya Raman', 'Communications', 'desktop', 'Media relations manager. Handles reporters, guards against speculation.'),
  p(5, 'Hafiz Osman', 'Communications', 'phone', 'Junior comms associate, 8 months in. Eager but unsure what he is allowed to say.'),

  // Legal — verification gatekeeper, defamation and regulatory exposure
  p(6, 'Shahrizal Kamaruddin', 'Legal', 'desktop', 'General Counsel. Cautious, insists nothing goes out unverified.'),
  p(7, 'Grace Lim Hui Ling', 'Legal', 'desktop', 'Corporate counsel. Focused on regulatory duties and disclosure obligations.'),
  p(8, 'Imran Yusof', 'Legal', 'phone', 'Legal associate tracking defamation risk in named-individual posts.'),
  p(9, 'Devi Krishnan', 'Legal', 'desktop', 'Compliance officer. Owns the audit trail and case references.'),
  ...
  p(11, 'Zainab Mokhtar', 'Stakeholder Management', 'desktop', 'Director of Stakeholder Relations. Manages board and MP expectations.'),
  p(12, 'Alvin Goh', 'Stakeholder Management', 'desktop', 'Government relations manager. Briefs policymakers, avoids surprises.'),
  p(13, 'Sharifah Nadia', 'Stakeholder Management', 'phone', 'Community leaders liaison. Trusted by mosque committees.'),
  p(14, 'Rajesh Pillai', 'Stakeholder Management', 'phone', 'Board secretariat. Prepares decision items and escalations.'),
  p(15, 'Nadia Halim', 'Stakeholder Management', 'phone', 'Stakeholder analyst, 1 year in. Still learning who to escalate to.'),

  // Partnerships and Engagement — mosques, partner NGOs, service continuity
  p(16, 'Faizal Rahman', 'Partnerships and Engagement', 'desktop', 'Head of Partnerships. Protects mosque and NGO relationships.'),
  p(17, 'Cheryl Ong', 'Partnerships and Engagement', 'desktop', 'Corporate partnerships manager. Handles CSR partners considering a pause.'),
  p(18, 'Amirah Zulkifli', 'Partnerships and Engagement', 'phone', 'Programme engagement lead. Closest to beneficiaries on the ground.'),
  p(19, 'Sanjay Menon', 'Partnerships and Engagement', 'phone', 'Volunteer network coordinator. Fields frontline anxiety.'),
  p(20, 'Khairul Anwar', 'Partnerships and Engagement', 'phone', 'Partnerships associate, 6 months in. Nervous about speaking for AMP.'),

  // Fundraising — donors, funders, restricted funds, donation infrastructure
  p(21, 'Siti Nurhaliza Aziz', 'Fundraising', 'desktop', 'Director of Development. Owns donor confidence and funder assurance.'),
  p(22, 'Jonathan Lee', 'Fundraising', 'desktop', 'Major gifts manager. Handles refund requests and pledge renewals.'),
  p(23, 'Rizwan Mahmood', 'Fundraising', 'phone', 'Donor care lead. Watches the hotline and donation platform health.'),
  p(24, 'Anitha Selvam', 'Fundraising', 'phone', 'Grants manager. Tracks restricted fund conditions and tranche holds.'),
  p(25, 'Norhayati Ismail', 'Fundraising', 'phone', 'Fundraising associate, 1 year in. Unsure which numbers are public.'),
];

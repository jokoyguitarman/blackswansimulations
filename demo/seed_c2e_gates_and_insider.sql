...
BEGIN
  ...
  SET
    ...
    insider_knowledge = jsonb_build_object(
      ...
      'sector_standards', 'Evacuation (ICS): marshal-to-evacuee ratio 1:10–20; predefined, congestion-managed routes; assembly area capacity at least 125% of expected evacuees. Triage (WHO MCI): triage staff-to-critical patient ratio 1:5; use START protocol; triage zone capacity ~50 patients; real-time communication with nearby hospitals. Media (ICRC/UNOCHA): one designated spokesperson; safe media zone for briefings; coordinated updates every 1–2 hours. Second device (suspected device near Exit B): cordon and clear the area before potential detonation. Minimum standoff 50 m; preferred 300 m for person-borne devices. If area is cleared before detonation, no additional casualties.',

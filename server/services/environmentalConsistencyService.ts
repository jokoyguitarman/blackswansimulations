...
/** When consistent is false: "contradiction" = wrong vs standards; "below_standard" = short of sector standard. */
 ...
 * hazard-specific requirements, and operational specificity.
 *
...
Return ONLY valid JSON:
{
  ...
  "feedback": "..." (only if specific is false — in-world consequence)
    ...
    const userPrompt = `${hazardStandardsBlock}${sectorStandardsLine}${teamRoleLine}${escalationLine}${incidentUserBlock}DECISION:
Title: ${decision.title}
Description: ${decision.description}

Evaluate this decision against professional response standards and operational specificity. ALL "reason" and "feedback" text must be IN-WORLD CONSEQUENCES only — describe what is happening on the ground as a result of the decision. NEVER tell the player what is wrong, what they should do, or what is missing.

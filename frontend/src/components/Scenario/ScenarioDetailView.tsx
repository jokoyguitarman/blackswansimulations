...
import { SocialScenarioEditor } from './SocialScenarioEditor';
...
export const ScenarioDetailView = ({ scenarioId, onClose }: Props) => {
  ...
  if (scenario.category === 'social_media_crisis') {
    return (
      <SocialScenarioEditor
        scenarioId={scenarioId}
        scenario={scenario as unknown as Parameters<typeof SocialScenarioEditor>[0]['scenario']}
        injects={injects as unknown as Parameters<typeof SocialScenarioEditor>[0]['injects']}
        teams={teams as unknown as Parameters<typeof SocialScenarioEditor>[0]['teams']}
        onClose={onClose}
      />
    );
  }

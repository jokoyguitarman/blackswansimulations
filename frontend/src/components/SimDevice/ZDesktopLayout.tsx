  ...
  return (
    <div className="h-screen w-screen flex" style={{ backgroundColor: '#000', color: '#E7E9EA' }}>
      ...
      >
        ...
        <nav className="flex-1 space-y-1">
          {NAV_ITEMS.map((item) => (
            <button
              ...
              className="flex items-center gap-4 w-full px-3 py-3 rounded-full hover:bg-white/10 transition-colors outline-none focus:outline-none"
              style={{ color: activeNav === item.id ? '#E7E9EA' : '#E7E9EA' }}
            >
        ...
        {/* Post Button */}
        <button
          className="w-full py-3 rounded-full text-[16px] font-bold mt-4 hover:opacity-90 transition-opacity outline-none focus:outline-none"
        ...
        {/* User Info */}
        <div className="flex items-center gap-3 mt-4 px-3 py-2 rounded-full hover:bg-white/10 transition-colors cursor-pointer">
          <div
          ...
          <div className="flex-1 min-w-0">
            <div className="text-[14px] font-bold truncate">Participant</div>
      ...
      <div
        ...
        style={{ maxWidth: 620, borderRight: '1px solid #2F3336' }}
      >
        <SocialFeedApp />
      </div>
          ...
          {topics.map((topic, i) => (
            ...
            >
              <div className="text-[13px]" style={{ color: '#71767B' }}>
                {topic.trend === 'hot' ? 'Trending in Crisis' : 'Crisis Update'}
              </div>
